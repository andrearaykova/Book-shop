...
class CreatePage extends Component {
  ...
  onSubmit (e) {
    e.preventDefault()
    if (!createProductValidator(this.state.title,
      this.state.description, this.state.image, this.state.author, this.state.price)) {
      return
    }
    this.props.createProduct(this.state.title,
      this.state.description, this.state.image, this.state.author, this.state.price)
  }
...
function mapDispatchToProps (dispatch) {
  return {
    createProduct: (title, description, image, author, price) => {
      dispatch(createProductAction({title, description, image, author, price}))
    },
